...
public class DBM {
	 ...
	 * Colunas que serão returnadas Ex: "column1, column2"
	 * 
	 * @return List<?>
	 */
	 ...
	 * 
	 * @param query
	 * String com a query que aceita parâmetros Ex: "select * from table where column = ?"
	 * 
	 * @param parameters
	 * Array de objetos que possa ser convertido pra string, que contem os valores dos parâmetros respectivamente
	 * 
	 * @return List<?>
	 */
	 ...
	 * 
	 * @param requiredColumns
	 * Colunas que terão o seu valor setado Ex: "column1, column2"
	 * 
	 * @param stringValues
	 * Valores das colunas passadas no parâmetro "requiredColumns" Ex: "1,'teste',null"
	 */
	 ...
	 * Clausula "where" para remoção de registro Ex: "column = 1"
	 */
	 ...
	 * 
	 * @param query
	 * String com a query que aceita parâmetros Ex: "update table set column = ? where column2 = ?"
	 * 
	 * @param parameters
	 * Array de objetos que possa ser convertido pra string, que contem os valores dos parâmetros respectivamente
	 * 
